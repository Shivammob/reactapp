...
const filterReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case "lowest":
      ...
      return {
        ...state,
        // sorting_value: action.type,
        filter_products: [...state.filter_products].sort((a, b) => a.price - b.price),
      };
    ...
    case "highest":
      return {
        ...state,
        // sorting_value: action.type,
        filter_products: [...state.filter_products].sort((a, b) => b.price - a.price),
      };
      ...
      return {
       ...state,
      //  sorting_value: action.type,
       filter_products: [...state.filter_products].sort((a, b) => a.name.localeCompare(b.name)),
      }
      ...
      return {
       ...state,
      //  sorting_value: action.type,
      filter_products: [...state.filter_products].sort((a, b) => b.name.localeCompare(a.name)),
      }
...
function Brand({ sizeFilter, setSizeFilter, data }) {
  ...
  useEffect(() => {
    dispatch({ type: "ADD_DATA", filter_products: data });
  }, [data]);

  // const sorting = (value) => {
  //   // dispatch({ type: "LOWEST" })
